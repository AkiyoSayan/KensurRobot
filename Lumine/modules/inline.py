...
import Lumine.modules.sql.users_sql as sql
from Lumine import (
    OWNER_ID,
    SUDO_USERS,
    SUPPORT_USERS,
...
from Lumine.modules.helper_funcs.misc import article
from Lumine.modules.helper_funcs.decorators import kensurinline
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    if user.id == OWNER_ID:
        ...
        text += f"\n\nThis Person is a part of Tedezas Chan Club"
        nation_level_present = True
