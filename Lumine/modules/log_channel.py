...
if is_module_loaded(FILENAME):
    ...
    from Lumine import EVENT_LOGS, LOGGER, dispatcher
    from Lumine.modules.helper_funcs.chat_status import user_admin
    from Lumine.modules.sql import log_channel_sql as sql
